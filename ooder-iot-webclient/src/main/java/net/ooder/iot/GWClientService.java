...
import  net.ooder.iot.json.device.GatewayActivate;
import  net.ooder.iot.json.device.GatewayErrorReport;
import  net.ooder.iot.json.device.GatewayRegister;
...
import  net.ooder.iot.json.device.SensorListInfo;
